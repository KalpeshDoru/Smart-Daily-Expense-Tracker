...
import com.imkalpesh.expense.presentation.screen.home.TransactionList
import com.imkalpesh.expense.utils.Utils

@Composable
fun StaticsScreen(navController: NavController, viewModel: StaticsViewModel = hiltViewModel()) {
    Scaffold(topBar = {
        Box(
            modifier = Modifier
                .fillMaxWidth()
